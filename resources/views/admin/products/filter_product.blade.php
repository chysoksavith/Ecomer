<div class="form-group">
    ...
    <select class="custom-select rounded-0" name="fabric">
...
<div class="form-group">
    ...
    <select class="custom-select rounded-0" name="sleeve">
...
<div class="form-group">
    ...
    <select class="custom-select rounded-0" name="pattern">
...
<div class="form-group">
    ...
    <select class="custom-select rounded-0" name="fit">
...
<div class="form-group">
    ...
    <select class="custom-select rounded-0" name="occasion">
