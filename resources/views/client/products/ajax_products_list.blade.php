    ...
    <div class="pagination">
        ...
        ?>
        {{ $categoryProducts->appends(array_filter(['sort' => $_GET['sort'], 'color' => $_GET['color'], 'size' => $_GET['size'], 'brand' => $_GET['brand'], 'price' => $_GET['price']
        , 'fabric' => $_GET['fabric'], 'fit' => $_GET['fit'], 'pattern' => $_GET['pattern'], 'sleeve' => $_GET['sleeve'], 'occasion' => $_GET['occasion']]))->links() }}
    </div>
